...
Ou, si tu publies la lib dans le registre PlatformIO :

ini
lib_deps =
    prune74/CanUniversal
📁 Structure du projet
Code
CanUniversal/
 ├── src/
 ...
 └── LICENSE
🚀 Exemple minimal
Voici un exemple simple d’utilisation (à mettre dans examples/BasicExample/BasicExample.ino) :
